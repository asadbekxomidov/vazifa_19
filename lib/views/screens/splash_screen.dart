...
import 'package:vazifa_19/views/screens/home_screen.dart';
import 'package:vazifa_19/views/screens/home_screen_bloc.dart';
  ...
  void initState() {
    ...
    Future.delayed(const Duration(seconds: 2), () {
      Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (context) => const HomeScreenBloc(),
